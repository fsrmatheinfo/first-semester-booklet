...
\begin{figure}[!t]
    \centering
    \includegraphics[scale=0.4]{fsrsw}
...
\begin{table}[!h]
    \centering\fbox{
    \begin{tabular}{llll}
        Sprecherin    & Delia Elmrich
                    & Master Informatik & 5.~Sem.\\
                    & \multicolumn{3}{l}{\email{delia.elmrich@fsr-matheinfo.de}}\\
                       \\
        Stell-      & Luzie Schmollack
                    & Bachelor Mathematik & 5.~Sem.\\
        vertreterin   & \multicolumn{3}{l}{\email{luzie.schmollack@fsr-matheinfo.de}}\\
                       \\
        Finanzerin~I  & Iris Eckert
                    & Master Bioinformatik & 3.~Sem.\\
                    & \multicolumn{3}{l}{\email{iris.eckert@fsr-matheinfo.de}}\\
                       \\
        Finanzer~II & Steffen Manigk
...
\email{richard.schmidt@student.uni-halle.de}
