...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{Jahrbuch_sw}
    \caption{v.l.n.r.: Felix~Schönheit, Lukas~Wilhelm~Rettler, Jan~Heinrich~Reimer, Anna~Hemmann, Tuğçe~Kuru, Luis~Imsande, Marissa~Eronika, Peter~Böttcher}
             \label{fig:fsr}
\end{figure}

\newpage
Der Fachschaftsrat ist die Interessenvertretung der Studentinnen und Studenten eines Fachbereichs und besteht in unserem Fall aus acht Mitgliedern, welche jedes Jahr im Mai neu gewählt werden.
...
Gleiches gilt für besondere Aufgaben, die eigentlich nicht zum Studium gehören (z.B. Programmierwettbewerbe, Seminare etc.).
