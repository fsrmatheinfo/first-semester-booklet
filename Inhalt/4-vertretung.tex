...
\begin{figure}[!t]
    \centering
    \includegraphics[scale=0.3]{fsr13_14test.png}
...
\begin{table}[!h]
    \centering\fbox{
    \begin{tabular}{llll}
        Sprecher    & Marie-Luise Hein
                    & Master Mathematik & 3.~Sem.\\
                    & \multicolumn{3}{l}{\email{marie-luise.hein@fsr-matheinfo.de}}\\
                       \\
        Stell-      & Delia Elmrich
                    & Master Inforamtik & 3.~Sem.\\
        vertreter   & \multicolumn{3}{l}{\email{delia.elmrich@fsr-matheinfo.de}}\\
                       \\
        Finanzer~I  & Mara Jakob
                    & Lehramt Mathematik & 7.~Sem.\\
                    & \multicolumn{3}{l}{\email{mara.jakob@fsr-matheinfo.de}}\\
                       \\
        Finanzer~II & Alexander Weiß
                    & Master Informatik  & 3.~Sem.\\
                    & \multicolumn{3}{l}{\email{alexander.weiss@fsr-matheinfo.de}}\\
                       \\
                    & Martin Schneider
                    & Bachelor Informatik & 13.~Sem.\\
                    & \multicolumn{3}{l}{\email{martin.schneider@fsr-matheinfo.de}}\\
                       \\
                    & Iris Eckert
                    & Master Bioinformatik & 1.~Sem.\\
                    & \multicolumn{3}{l}{\email{iris.eckert@fsr-matheinfo.de}}\\
                       \\
                    & Felix Knispel
                    & Master Informatik & 3.~Sem.\\
                    & \multicolumn{3}{l}{\email{felix.knispel@fsr-matheinfo.de}}
    \end{tabular}}
    \caption{Mitglieder des Fachschaftsrats 2012/13}
\end{table}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=\textwidth]{studentische_gremien}\\
...
\email{fachschaft@mathinf.uni-halle.de}\\
\email{marie-luise.hein@student.uni-halle.de}\\
\email{theo.lau@student.uni-halle.de}
