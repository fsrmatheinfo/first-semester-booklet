...
\subsubsection{im StudIP}
    \verweis{Studienforum Mathematik}, 
    \verweis{Studienforum Informatik} 
\subsubsection{im studiVZ}
    Profil: \verweis{Fachschaftsrat Mathe/Info} \\
    Gruppe: \verweis{Fachschaft Mathe/Info MLU Halle}
\subsubsection{facebook}
    Profil: \verweis{Fachschaftsrat MatheInfo} \\
    Gruppe: \verweis{Institut für Informatik},\\ \phantom{Gruppe:} \verweis{Martin-Luther-Universität Halle-Wittenberg}
\subsubsection{per Twitter}
    \web{http://twitter.com/FsrMatheInfo/}
