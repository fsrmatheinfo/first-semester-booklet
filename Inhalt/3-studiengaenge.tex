...
Wenn ihr noch Fragen habt, zögert nicht den Fachschaftsrat oder euren Studienberater anzusprechen.

\textbf{Ansprechpartner im Fachschaftsrat:}\\
Jan Heinrich Reimer, \email{jan.heinrich.reimer@fsr-matheinfo.de}\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% BIOINFORMATIK %%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\textbf{Ansprechpartner im Fachschaftsrat:}\\
Tuğçe Kuru, \email{tugce.kuru@fsr-matheinfo.de}
...
\begin{table}[tbp]
	\begin{small}
		\begin{tabularx}{\textwidth}{|b{.4\textwidth}|X|X|l|}
			\hline
...
\textbf{Ansprechpartner im Fachschaftsrat:}\\
Lukas Rettler, \email{lukas.rettler@fsr-matheinfo.de}\\
Felix Schönheit, \email{felix.schoenheit@fsr-matheinfo.de}\\
