...
\definecolor{OurLinkColor}{rgb}{0.1,0.1,0.5} % Schönes Blau für die Links im Dokument
...
\newpage
\input{Inhalt/1-begruessung}
\newpage
\input{Inhalt/2-creditpoints}
\newpage
\input{Inhalt/3-studiengaenge}
\newpage
\input{Inhalt/4-vertretung}
\newpage
\input{Inhalt/5-studiereninhalle}
\newpage
\input{Inhalt/6-hilfen}
\newpage
\input{Inhalt/7-anhang}
